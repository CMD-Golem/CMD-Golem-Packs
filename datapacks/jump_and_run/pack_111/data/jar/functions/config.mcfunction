...
#Give
replaceitem entity @a[tag=jar_config_ok] hotbar.0 minecraft:creeper_spawn_egg{display:{Name:"{\"translate\":\"Start\",\"color\":\"gold\",\"bold\":true}",Lore:["If a Player steps on these Point the Jump and Run will start"]},EntityTag:{Tags:["jar_s_start"]}}
replaceitem entity @a[tag=jar_config_ok] hotbar.1 minecraft:mooshroom_spawn_egg{display:{Name:"{\"translate\":\"End\",\"color\":\"gold\",\"bold\":true}",Lore:["The End of the Jump and Run"]},EntityTag:{Tags:["jar_s_ziel"]}}
replaceitem entity @a[tag=jar_config_ok] hotbar.2 minecraft:spider_spawn_egg{display:{Name:"{\"translate\":\" Check Point\",\"color\":\"gold\",\"bold\":true}",Lore:["If the Player die he will tp back to the latest Check Point"]},EntityTag:{Tags:["jar_s_cpoint"]}}
replaceitem entity @a[tag=jar_config_ok] hotbar.6 minecraft:salmon_spawn_egg{display:{Name:"{\"translate\":\"Reset\",\"color\":\"gold\",\"bold\":true}",Lore:["Resets all Settings"]},EntityTag:{Tags:["jar_s_kill"]}}
replaceitem entity @a[tag=jar_config_ok] hotbar.8 minecraft:tropical_fish_spawn_egg{display:{Name:"{\"translate\":\"Leave Config\",\"color\":\"gold\",\"bold\":true}"},EntityTag:{Tags:["jar_s_leave"]}}
