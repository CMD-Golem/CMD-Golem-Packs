...
#Give
item replace entity @a[tag=jar_config_ok] hotbar.0 with minecraft:creeper_spawn_egg{CustomModelData:987,display:{Name:"{\"translate\":\"Start\",\"color\":\"gold\",\"bold\":true,\"italic\":false}",Lore:["If a Player steps on these Point the Jump and Run will start"]},EntityTag:{Tags:["jar_s_start"]}}
item replace entity @a[tag=jar_config_ok] hotbar.1 with minecraft:mooshroom_spawn_egg{CustomModelData:987,display:{Name:"{\"translate\":\"End\",\"color\":\"gold\",\"bold\":true,\"italic\":false}",Lore:["The End of the Jump and Run"]},EntityTag:{Tags:["jar_s_ziel"]}}
item replace entity @a[tag=jar_config_ok] hotbar.2 with minecraft:spider_spawn_egg{CustomModelData:987,display:{Name:"{\"translate\":\" Check Point\",\"color\":\"gold\",\"bold\":true,\"italic\":false}",Lore:["If the Player die he will tp back to the latest Check Point"]},EntityTag:{Tags:["jar_s_cpoint"]}}
item replace entity @a[tag=jar_config_ok] hotbar.6 with minecraft:salmon_spawn_egg{CustomModelData:987,display:{Name:"{\"translate\":\"Reset\",\"color\":\"gold\",\"bold\":true,\"italic\":false}",Lore:["Resets all Settings"]},EntityTag:{Tags:["jar_s_kill"]}}
item replace entity @a[tag=jar_config_ok] hotbar.8 with minecraft:tropical_fish_spawn_egg{CustomModelData:987,display:{Name:"{\"translate\":\"Leave Config\",\"color\":\"gold\",\"bold\":true,\"italic\":false}"},EntityTag:{Tags:["jar_s_leave"]}}
