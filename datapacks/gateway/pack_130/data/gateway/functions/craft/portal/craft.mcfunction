...
give @a[tag=gateway_portal_craft] minecraft:phantom_spawn_egg{display:{Name:'{"text":"Gateway","italic":false}'},EntityTag:{id:"minecraft:marker",Tags:["gateway_point"]},CustomModelData:4268769}
