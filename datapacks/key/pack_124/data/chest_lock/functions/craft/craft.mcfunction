...
give @a[tag=chestlock_craft] minecraft:warped_fungus_on_a_stick{display:{Name:'{"text":"Key","italic":false}',Lore:['{"text":"Shift right click a Chest to lock and open it","color":"gray","italic":false}']},CustomModelData:4268953,chestlock_item:1b} 1
